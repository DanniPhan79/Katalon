...
Mobile.waitForElementPresent(findTestObject('Android/Dynamic/lbl_text', [('text') : fromAccountNumber]), timeout, FailureHandling.STOP_ON_FAILURE)
...
'To Nickname'
Mobile.verifyElementExist(findTestObject('Android/Dynamic/lbl_text', [('text') : toNickname]), timeout, FailureHandling.CONTINUE_ON_FAILURE)
...
'Amount'
Mobile.verifyElementExist(findTestObject('Android/Dynamic/lbl_text', [('text') : amount]), timeout, FailureHandling.CONTINUE_ON_FAILURE)

'Transaction Detail'
Mobile.verifyElementExist(findTestObject('Android/Dynamic/lbl_text', [('text') : transactionDetail]), timeout, FailureHandling.CONTINUE_ON_FAILURE)

'Fee'
Mobile.verifyElementExist(findTestObject('Android/Dynamic/lbl_text', [('text') : fee + " VND"]), timeout, FailureHandling.CONTINUE_ON_FAILURE)
