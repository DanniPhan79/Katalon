...
WebUI.callTestCase(findTestCase('Web Commons/Transfer Money Page/Select Expense Type'), [('timeout') : 2, ('text') : 'Chuyển tiền'], 
    FailureHandling.STOP_ON_FAILURE)

'Select Destination Bank-noibo OCB'
WebUI.callTestCase(findTestCase('Web Commons/Transfer Money Page/Select Destination Bank Page/Select Transfer Type'), [('destinationBank') : ''
        , ('text') : 'Trong OCB'], FailureHandling.STOP_ON_FAILURE)

'Select Type to Send'
WebUI.callTestCase(findTestCase('Web Commons/Transfer Money Page/Select Destination Bank Page/Select Type to Send'), [('text') : 'Số điện thoại'], 
    FailureHandling.STOP_ON_FAILURE)

'Enter Account Number'
WebUI.callTestCase(findTestCase('Web Commons/Transfer Money Page/Enter Recipient Information Page/Enter Account Number - Noibo'), 
    [('accountNumber') : recipientAccount], FailureHandling.STOP_ON_FAILURE)

'Entering Data'
WebUI.callTestCase(findTestCase('Web Commons/Transfer Money Page/Entering Data Page/Entering Data - noibo'), [('transferAmount') : amount
